...
; RUN: if [ %llvmver -ge 16 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,function(mem2reg,sroa,simplifycfg,instsimplify,gvn,adce)" -enzyme-preopt=false -S | FileCheck %s; fi
